...
** and
** [Client company name] a company incorporated in [England & Wales] (registration number [no]) whose registered office and trading address is at [address] (‘the Client’).
